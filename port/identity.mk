# Author-approved v0.6.0 candidate for INTEG-007 General Poll qualification.
# The passing v0.5.0 candidate remains the working rollback.
EMOS_PROFILE_ROOT := $(abspath $(dir $(lastword $(MAKEFILE_LIST)))/..)
EMOS_SOURCE_IDENTITY := agon-emos-v0.6.0
